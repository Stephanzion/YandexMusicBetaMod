  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive border bg-background dark:bg-card shadow-xs border-input hover:bg-card dark:hover:bg-input/30",
        className,
      )}
      {...props}
    />
