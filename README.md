...
Отображение текущего трека в вашем профиле дискорда на данный момент тестируется. Если функция не работает, попробуйте полностью закрыть дискорд и Яндекс Музыку, а затем попробовать снова.
